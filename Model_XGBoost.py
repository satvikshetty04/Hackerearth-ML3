...
train.drop(['weekday','minute','siteid'], axis = 1, inplace=True)
test.drop(['weekday','minute','siteid'], axis = 1, inplace=True)
...
pred_df.to_csv(path_or_buf="Predictions\\prediction_8.csv", index=False)